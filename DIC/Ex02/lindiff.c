...
/*--------------------------------------------------------------------------*/
/*                                                                          */
/*                 ISOTROPIC LINEAR DIFFUSION FILTERING                     */
/*                                                                          */
...
/* 
 Explicit scheme on a (3*3)-stencil for the isotropic linear diffusion 
 equation.  The scheme is stable for time steps ht <= 0.25. Then it 
 preserves the average grey value and satisfies an extremum principle. 
*/
