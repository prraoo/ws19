...
void dilation 
     ...
     (long     nx,        /* image dimension in x direction */
      ...
      float    **u)       /* input: original image;  output: dilated */

/*
 Rouy-Tourin 2-D dilation.
*/
...
printf ("\n");
printf ("ROUY-TOURIN SCHEME FOR DILATION WITH FLAT DISK\n\n");
printf ("**********************************************\n\n");
...
comments[0]='\0';
comment_line (comments, "# dilation with flat disk, Rouy-Tourin scheme\n");
